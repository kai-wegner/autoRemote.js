...
**/
exports.registerServerToDevice = function(serverConfig,device) {
	getServerConfig(serverConfig).
		then(function(serverConfig) {
			...
			registration_message.type = "eventghost";			
			...
			registration_message.port = serverConfig.interfaces.public.port;
			registration_message.haswifi = true;
			
			registration_message.send();
		});
}
